      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mb-3 ml-9">
            Go to Meta Developers and create a WhatsApp
            Business app.
          </p>
          <a
        ...
        <div className="border-t border-gray-100 pt-5">
          ...
          <p className="text-sm text-gray-500 mb-4 ml-9">
            Copy your WhatsApp credentials from Meta and
        ...
        <div className="border-t border-gray-100 pt-5">
          ...
          <p className="text-sm text-gray-500 mb-3 ml-9">
            Give customers this link to start chatting
            with your store bot:
          </p>
